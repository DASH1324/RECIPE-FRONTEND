// src/components/UI/Home.jsx  (or wherever your Home component is)
...
const Home = () => {
  ...
  // Refs for smooth scrolling (this logic remains the same)
  ...
  // 3. Create a handler to navigate to the authentication page
  const handleSignUpClick = () => {
    // According to your App.jsx, the component with the signup form is at the "/auth" path
    navigate("/auth"); 
  };
  ...
  return (
    <div className="home-container">
      ...
      {/* Attach ref to the Recipe Preview section */}
      ...
      <section className="cta-section">
        <div className="cta-content">
          ...
          <div className="cta-buttons">
            {/* 4. Attach the onClick handler to the "Sign Up Now" button */}
