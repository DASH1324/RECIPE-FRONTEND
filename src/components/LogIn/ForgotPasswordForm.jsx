...
// REMOVED props like onCancel, onSubmit, isOpen to make it a self-contained page
const ForgotPasswordForm = () => {
  ...
  const handleSubmit = async (values) => {
    ...
    try {
      // --- FIX #1: Use the correct Vite environment variable for the BASE URL ---
      const apiUrl = import.meta.env.VITE_BACKEND_URL || 'https://recipe-ctre.onrender.com';
      
      // --- FIX #2: Construct the full endpoint URL correctly here ---
        ...
        <BoxContent>
          {isSuccess ? (
            <div className="success-message">
              ...
              {/* --- FIX #3: Use navigate() for the button click --- */}
