...
// --- Zod Schema (No changes needed here) ---
...
const SignupForm = ({ onSubmitSuccess = () => {}, onAcknowledgeSuccess = () => {} }) => {
  ...
  const handleInitialSubmit = async (data) => {
    ...
    try {
      ...
      await axios.post("https://recipe-ctre.onrender.com/auth/request-verification", {
        full_name: data.name,
  ...
  const handleOtpSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post("https://recipe-ctre.onrender.com/auth/verify-and-register", {
